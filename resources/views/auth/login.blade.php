    ...
    <div class="login login-1 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white" id="kt_login">
        ...
        <div class="login-aside d-flex flex-column flex-row-auto" style="background-color: #1e1e2d;background-image: url({{ asset('backend/assets/media/bg/bg-2.jpg') }});">
            ...
            <div class="d-flex flex-column-auto flex-column pt-lg-10 pt-15">
                ...
                <!--end::Aside header-->
                <!--begin::Aside title-->
                <h3 class="font-weight-bolder text-center font-size-h4 font-size-h1-lg" style="color: #c8c8c8;">Turzz Yönetim Sistemi
                 </h3>
            </div>
            <!--end::Aside Top-->
            <!--begin::Aside Bottom-->
        ...
        <div class="login-content flex-row-fluid d-flex flex-column justify-content-center position-relative overflow-hidden p-7 mx-auto">
                ...
                <div class="login-form login-signin">
                    <form class="form" action="{{ route('user.login') }}" method="POST">
                        ...
                        <div class="pb-13 pt-lg-0 pt-5">
                            <h3 class="font-weight-bolder text-dark font-size-h4 font-size-h1-lg">CRM Portalına Giriş Yap</h3>
                        ...
                        <div class="form-group">
                            <div class="d-flex justify-content-between mt-n5">
                                ...
                                <a href="{{ Route('password.request') }}" class="text-primary font-size-h6 font-weight-bolder text-hover-primary pt-5" id="kt_login_forgot">Şifreni mi unuttun ?</a>
                                @endif
                            </div>
                        ...
                        <div class="pb-lg-0 pb-5">
                            @csrf
                            <button type="submit" class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3 fullbtnwidth">Giriş Yap</button>
                        </div>
                        <!--end::Action-->
                    </form>
                    <!--end::Form-->
            ...
            <div class="d-flex justify-content-lg-start justify-content-center align-items-end py-7 py-lg-0">
                <div class="text-dark-50 font-size-lg font-weight-bolder mr-10">
                    ...
                    <a href="{{ Route('login') }}" target="_blank" class="text-dark-75 text-hover-primary">Turzz CRM</a>
                </div>
            </div>
            <!--end::Content footer-->
        </div>
