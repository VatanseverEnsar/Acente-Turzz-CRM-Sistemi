<html lang="tr" >
    ...
    <head>
        <meta charset="utf-8" />
    <title>Şifre Yenile | Turzz Yönetim Paneli</title>
        ...
        <div class="login-content flex-row-fluid d-flex flex-column justify-content-center position-relative overflow-hidden p-7 mx-auto">
            ...
            <div class="d-flex flex-column-fluid flex-center">
                ...
                <div class="login-form login-signin">
                    ...
                    @endif
                            <h3 class="font-weight-bolder text-dark font-size-h4 font-size-h1-lg">Şifre Yenile</h3>
                            <span class="text-muted font-weight-bold font-size-h4">Lütfen sisteme kayıtlı e-posta adresini giriniz. Şifre yenileme için size yeni bir bağlantı gönderilecektir.
                            </span>
                        </div>
                        <!--begin::Title-->
                        <!--begin::Form group-->
                        <div class="form-group">
                            ...
                            <input class="form-control form-control-solid h-auto py-6 px-6 rounded-lg {{ $errors->has('email') ? ' is-invalid' : '' }}" type="text" name="email" placeholder="Sisteme kayıtlı e-posta adresiniz" autocomplete="off" />
                            @if ($errors->has('email'))
                        ...
                        <div class="pb-lg-0 pb-5">
                            @csrf
                            <button type="submit" class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3 fullbtnwidth">Yeni Şifre Gönder</button>
                        </div>
                        <!--end::Action-->
                    </form>
                    <!--end::Form-->
            ...
            <div class="d-flex justify-content-lg-start justify-content-center align-items-end py-7 py-lg-0">
                <div class="text-dark-50 font-size-lg font-weight-bolder mr-10">
                    ...
                    <a href="{{ Route('login') }}" target="_blank" class="text-dark-75 text-hover-primary">Turzz</a>
                </div>
