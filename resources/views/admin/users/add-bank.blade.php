...
<div class="subheader py-2 py-lg-6 subheader-solid" id="kt_subheader">
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-2">
            <!--begin::Page Title-->
            <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Yeni Banka Hesabı Ekle</h5>
            ...
            <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                ...
                <li class="breadcrumb-item">
                    <a href="{{ Route('admin_user_add_banks',['id'=>$user->id]) }}" class="text-muted">Yeni Banka Hesabı Ekle</a>
                </li>
            </ul>
        </div>
        <!--end::Info-->
                ...
                <div class="card card-custom card-stretch">
                    ...
                    <div class="card-header py-3">
                        <div class="card-title align-items-start flex-column">
                            <h3 class="card-label font-weight-bolder text-dark">Yeni Banka Hesap Bilgisi Ekle</h3>
                            <span class="text-muted font-weight-bold font-size-sm mt-1"><span class="font-weight-boldest">{{ $user->name }}</span> kullanıcısı için yeni bir banka hesap bilgisi ekleyiniz.</span>
                        </div>
                    ...
                    <!--end::Header-->
                    <!--begin::Form-->
                    <form action="{{ Route('admin_user_add_banks_process') }}" id="addNewBank" method="POST" class="form" autocomplete="off">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-solid form-control-lg" name="bank_account_name" placeholder="Banka Hesap Adı"/>
                                ...
                                <div class="col-xl-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-solid form-control-lg" name="bank_name" placeholder="Banka Adı"/>
                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-solid form-control-lg" name="iban" placeholder="IBAN Numarası"/>
                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-solid form-control-lg" name="bank_code" placeholder="Hesap Şube Kodu"/>
                                ...
                                <div class="col-xl-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-solid form-control-lg" name="account_number" placeholder="Hesap Numarası"/>
                                        <span class="form-text text-muted">Bu alan zorunlu değildir.</span>
                                    </div>
                                </div>
                                <!--end::Group-->
