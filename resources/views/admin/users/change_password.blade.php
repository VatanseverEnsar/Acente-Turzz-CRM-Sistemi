    ...
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-2">
            ...
            <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                ...
                <li class="breadcrumb-item">
                    <a href="{{ Route('change_user_password',['id'=>$user->id]) }}" class="text-muted">Şifre Güncelle</a>
                </li>
            </ul>
        </div>
        <!--end::Info-->
        ...
        <div class="d-flex flex-row">
            ...
            <div class="flex-row-fluid ml-lg-8">
                ...
                <div class="card card-custom card-stretch">
                    ...
                    <!--end::Header-->
                    <!--begin::Form-->
                    <form action="{{ Route('change_user_password_process') }}" id="editPassword" method="POST" class="form" autocomplete="off">
                        @csrf
                        <div class="card-body">
                            <!--begin::Alert-->
                            <div class="alert alert-custom alert-light-danger fade show mb-10" role="alert">
                                ...
                                <div class="alert-text font-weight-bold">Şifreleri yönetim panelinde asla açık olarak gösterilmez. Bir kullanıcı için şifre görme işlemi yapamazsınız. Lütfen kullanıcı şifresi değiştirmeniz halinde kullanıcıya bunu haberdar ediniz.</div>
                                <div class="alert-close">
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                        <span aria-hidden="true">
                                            <i class="ki ki-close"></i>
