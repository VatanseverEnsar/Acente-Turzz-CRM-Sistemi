<html lang="tr" >
    ...
    <head>
        <meta charset="utf-8" />
    <title>Sayfa Bulunamadı | TouchPoint Crm</title>
    ...
    <link href="{{ asset('backend/assets/css/pages/error/error-5.css') }}" rel="stylesheet" type="text/css" />
...
<div class="d-flex flex-column flex-root">
    <!--begin::Error-->
    <div class="error error-5 d-flex flex-row-fluid bgi-size-cover bgi-position-center" style="background-image: url({{ asset('backend/assets/media/error/bg5.jpg') }});">
        <!--begin::Content-->
        <div class="container d-flex flex-row-fluid flex-column justify-content-md-center p-12">
            <h1 class="error-title font-weight-boldest text-info mt-10 mt-md-0 mb-12">Oops!</h1>
            <p class="font-weight-boldest display-4">404, HATA!</p>
            <p class="font-size-h3">Aradığınız içerik bulunamadı. Lütfen bağlantınız kontrol ediniz.</p>
        </div>
        <!--end::Content-->
    </div>
    <!--end::Error-->
